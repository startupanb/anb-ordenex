...
/**
 * Check that the file is above the maximum file upload size
 *
 * @param Object $model
 * @param mixed $check Value to check
 * @param int $size Maximum file size
 ...
 * @access public
 */
	public function isAboveMaxSize(&$model, $check, $size = null, $requireUpload = true) {
		$field = array_pop(array_keys($check));
 ...
 **/
	...
	public function _createThumbnails(&$model, $field, $path, $thumbnailPath) {
		...
		if ($isImage && $createThumbnails && $hasThumbnails) {
